<div class="container">
    ...
    <form method="post" action="<?= $customer->getId() == '' ? "/clientes/cadastrar" : '/clientes/atualizar' ?>" id="form-register">
        ...
        <fieldset class="customer-data-forms">
            ...
            <input type="text" placeholder="Nome do cliente (*)" value="<?= $customer->getFirstName() ?? ""  ?>" name="first_name" id="first_name" required>
            <input type="text" placeholder="Sobrenome do cliente (*)" value="<?= $customer->getLastName() ?? ""  ?>" name="last_name" id="last_name" required>
